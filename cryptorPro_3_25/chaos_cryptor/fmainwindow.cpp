...
/*keyboard*/
bool FMainWindow::eventFilter(QObject *watched, QEvent *event)
{
...
void FMainWindow::showKeyboardSlot()
{
    keyboard->show();
}

void FMainWindow::confirmstringSlot(QString inpuText)
{
    ui->textEdit->setText(inpuText);
}
